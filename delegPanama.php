...
<head>
	<!-- Titulo da Página -->
	<title>Delegação do Panamá</title>
...
<body style="background-image: url('img/olimpiada1.jpg');">
		...
		<?php
			...
			$banco = "world";	// nome do banco
				...
				$sql= "SELECT atl.Nome_atleta,concat(FLOOR(DATEDIFF(NOW(), atl.Dt_Nasc) / 365),' Anos') as idade, Nome_Mod, Nome_Tec 
						FROM atleta atl
...
<div id="conteudo">
	...
	<!-- Alinha tudo que vai na descrição do conteudo dentro da área demarcada -->
		...
		<p style="opacity: 1;"> <h1>Panamá</h1></p>
